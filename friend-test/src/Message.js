...
import { collection, addDoc } from '@firebasse/firestore'
            ...
            >
                ...
                <button
                    onClick={async () => {
                        ...
                        const docRef = await addDoc(collection(db, "ranking"), {score: parseInt(score), name: user_name, message: input_text.current.value}
